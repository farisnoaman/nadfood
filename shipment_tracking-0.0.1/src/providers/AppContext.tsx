            ...
            try {
                ...
                try {
                    ...
                    if (session) {
                        ...
                        if (companySettings) {
                            setAppName(companySettings.app_name || cachedAppName);
                            setCompanyName(companySettings.company_name || cachedCompanyName);
                            setCompanyAddress(companySettings.company_address || cachedCompanyAddress);
                            setCompanyPhone(companySettings.company_phone || cachedCompanyPhone);
                            setCompanyLogo(companySettings.company_logo || cachedCompanyLogo);
